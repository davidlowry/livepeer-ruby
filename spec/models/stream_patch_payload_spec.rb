...
# Unit tests for livepeer::StreamPatchPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe livepeer::StreamPatchPayload do
  let(:instance) { livepeer::StreamPatchPayload.new }

  describe 'test an instance of StreamPatchPayload' do
    it 'should create an instance of StreamPatchPayload' do
      expect(instance).to be_instance_of(livepeer::StreamPatchPayload)
    end
  end
