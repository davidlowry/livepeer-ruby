...
# Unit tests for livepeer::SigningKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe livepeer::SigningKey do
  let(:instance) { livepeer::SigningKey.new }

  describe 'test an instance of SigningKey' do
    it 'should create an instance of SigningKey' do
      expect(instance).to be_instance_of(livepeer::SigningKey)
    end
  end
