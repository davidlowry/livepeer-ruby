...
# Unit tests for livepeer::Asset
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe livepeer::Asset do
  let(:instance) { livepeer::Asset.new }

  describe 'test an instance of Asset' do
    it 'should create an instance of Asset' do
      expect(instance).to be_instance_of(livepeer::Asset)
    end
  end
  ...
  describe 'test attribute "video_spec"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
