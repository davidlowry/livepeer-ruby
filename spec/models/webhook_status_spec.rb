...
# Unit tests for livepeer::WebhookStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe livepeer::WebhookStatus do
  let(:instance) { livepeer::WebhookStatus.new }

  describe 'test an instance of WebhookStatus' do
    it 'should create an instance of WebhookStatus' do
      expect(instance).to be_instance_of(livepeer::WebhookStatus)
    end
  end
  describe 'test attribute "last_failure"' do
    it 'should work' do
