...
module livepeer
  ...
  class AttestationMessage
    ...
    def self.openapi_types
      {
        :'video' => :'String',
        :'attestations' => :'Array<AttestationMessageAttestationsInner>',
        :'signer' => :'String',
        :'timestamp' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `livepeer::AttestationMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `livepeer::AttestationMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @attestations.nil?
        invalid_properties.push('invalid value for "attestations", attestations cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @attestations.nil?
    ...
    def hash
      [video, attestations, signer, timestamp].hash
    end
